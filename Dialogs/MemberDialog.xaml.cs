...
namespace SnapAfghanistan.Native.Dialogs
{
    public partial class MemberDialog : Window
    {
        ...
        private void LoadRecord()
        {
            ...
            TypeCombo.SelectedItem = _record.Type;
            NameText.Text = _record.FirstName;
            FatherText.Text = _record.FatherName;
            TazkiraText.Text = _record.TazkiraNo;
            PhoneText.Text = _record.Phone;
            OriginalAddressText.Text = _record.OriginalAddress;
            CurrentAddressText.Text = _record.CurrentAddress;
            InstitutionText.Text = _record.Institution;
            StatusCombo.SelectedItem = _record.Status == "غیرفعال" ? "غیرفعال" : "فعال";
            NotesText.Text = _record.Notes;
            AttachmentText.Text = _record.AttachmentName;
        ...
        private void SetReadOnly()
        {
            ...
            FatherText.IsReadOnly = true;
            TazkiraText.IsReadOnly = true;
            PhoneText.IsReadOnly = true;
            OriginalAddressText.IsReadOnly = true;
            CurrentAddressText.IsReadOnly = true;
            InstitutionText.IsReadOnly = true;
            StatusCombo.IsEnabled = false;
            NotesText.IsReadOnly = true;
            ChooseAttachmentButton.Visibility = Visibility.Collapsed;
        ...
        private void Save_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                ErrorText.Text = "";
                _record.Type = Convert.ToString(TypeCombo.SelectedItem) ?? "معلم";
                _record.FirstName = NameText.Text.Trim();
                _record.FatherName = FatherText.Text.Trim();
                _record.TazkiraNo = TazkiraText.Text.Trim();
                _record.Phone = PhoneText.Text.Trim();
                _record.OriginalAddress = OriginalAddressText.Text.Trim();
                _record.CurrentAddress = CurrentAddressText.Text.Trim();
                _record.Institution = InstitutionText.Text.Trim();
